		...
		success: function (res) {
			...
			$.each(res.data, function (index, key) {
				tbUserData += `<tr>
                    ...
                    <td>
						<img src="${rootApp}public/global-images/news/${key.image}" class=" mr-2" height="50" width="50" alt="">
                    </td>
                    <td>
                        <h6 class="mb-0">
                            <a href="#">${key.title}</a>
                        ...
                        <div class="list-icons list-icons-extended">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="#" class="dropdown-item btn-edit" data-id="${key.news_id}"><i class="icon-file-plus"></i> Perbarui</a>
                                    <a href="#" class="dropdown-item btn-delete" data-id="${key.news_id}"><i class="icon-cross2"></i> Hapus</a>
                                </div>
                            </div>
                        </div>
                    </td>
