...
export function viewAllCity() {
	$.ajax({
		...
		success: function (res) {
			...
			// return tbCities;
			if ($(".table-city").length > 0) {
				$(".table-city").dataTable().fnDestroy();
				if ($("#table-body-city").length > 0) {
					$("#table-body-city").html(tbCities);
				}
				_initTableOwner("table-city");
			}
		},
