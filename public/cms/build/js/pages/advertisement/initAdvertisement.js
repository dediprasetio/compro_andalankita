...
export function viewAllAdvertisement() {
	$.ajax({
		url: rootApp + "api/advertisement",
		type: "GET",
		dataType: "json",
		success: function (res) {
			...
			$.each(res.data, function (index, key) {
				tbUserData += `<tr>
                    ...
                    <td>Semua Iklan</td>
                    <td>
						<img src="${rootApp}public/global-images/advertisement/${key.photo}" class=" mr-2" height="50" width="50" alt="">
                    </td>
                    <td>
                        <h6 class="mb-0">
                            <a href="#">${key.title}</a>
                    ...
                    <td>
						<span class="d-block font-size-sm text-muted">${key.description}</span>
                    </td>
                    <td>
                        ${key.updated_at}
                    </td>
                        ...
                        <div class="list-icons list-icons-extended">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="#" class="dropdown-item btn-edit" data-id="${key.id}"><i class="icon-file-plus"></i> Perbarui</a>
                                    <a href="#" class="dropdown-item btn-delete" data-id="${key.id}"><i class="icon-cross2"></i> Hapus</a>
                                </div>
                            </div>
                        </div>
                    </td>
