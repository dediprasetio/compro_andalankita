            ...
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white mb-0">Klien Kami</h5>
                            <h1 class="text-white mb-0" data-toggle="counter-up">129</h1>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            ...
                            <h1 class="mb-0" data-toggle="counter-up">987</h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h1 class="mb-0">Solusi Andalalin Terbaik & Paling Terpercaya</h1>
                </div>
                <p class="mb-4">Andalalinkita.com dibentuk dari kebutuhan para pelaku bisnis
                    ...
                    langsung dan berdampak pada sistem transportasi.</p>
                <div class="row g-0 mb-3">
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Best Prices</h5>
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Innovative Mindset</h5>
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Built Platform & Website</h5>
                    </div>
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Strong Brand Image & Equity</h5>
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Good Quality of After Sales</h5>
                        <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Very Relate to Society 5.0</h5>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                    ...
                    <div class="ps-4">
                        <h5 class="mb-2">Hubungi kami jika ada pertanyaan apapun</h5>
                        <h4 class="text-primary mb-0">+012 345 6789</h4>
                    </div>
                </div>
                <a href="<?= base_url("contact-us") ?>" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Lebih
                    Detail</a>
            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                        src="<?= base_url() ?>public/front-end-andalalinkita/img/about.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Kenapa Pilih Kami</h5>
            <h1 class="mb-0">Kami Hadir Sebagai Mitra Terbaik Untuk Membantu Anda</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="row g-5">
            ...
            <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s"
                        src="<?= base_url() ?>public/front-end-andalalinkita/img/feature.jpg"
            ...
            <div class="col-lg-4">
                <div class="row g-5">
                    ...
                    <!-- <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                            ...
                            <h4>Berfokus Membantu Bisnis Anda</h4>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <h1 class="mb-0">Produk <span class="color-orange">Analalinkita.com</span> Sebagai Solusi Bisnis Anda</h1>
        </div>
        <div class="row g-5">
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    <h5 class="fw-bold text-primary text-uppercase">Minta Penawaran / Diskusi</h5>
                    <h1 class="mb-0">Butuh Konsultasi Gratis? Bebas Untuk Menghubungi Kami</h1>
                </div>
                <div class="row gx-3">
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <h5 class="mb-4"><i class="fa fa-reply text-primary me-3"></i>Dibalas 2x 24 Jam</h5>
                    </div>
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
            ...
            <div class="col-lg-5">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?= base_url() ?>public/global-images/pages/Update_Andalalinkita_com_pdf1_pdf-image-156.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<!-- <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Apa yang klien katakan tentang services kami</h1>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="<?= base_url() ?>public/front-end-andalalinkita/img/testimonial-1.jpg" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="<?= base_url() ?>public/front-end-andalalinkita/img/testimonial-2.jpg" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="<?= base_url() ?>public/front-end-andalalinkita/img/testimonial-3.jpg" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <img class="img-fluid rounded" src="<?= base_url() ?>public/front-end-andalalinkita/img/testimonial-4.jpg" style="width: 60px; height: 60px;" >
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Client Name</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
...
<!-- <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Be Our Team</h5>
                <h1 class="mb-0">Professional Staff Yang Siap Membantu Anda</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="<?= base_url() ?>public/front-end-andalalinkita/img/team-1.jpg" alt="">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="<?= base_url() ?>public/front-end-andalalinkita/img/team-2.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-instagram fw-normal"></i></a>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="<?= base_url() ?>public/front-end-andalalinkita/img/team-3.jpg" alt="">
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-instagram fw-normal"></i></a>
    ...
    <div class="container py-5">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                <div class="blog-item bg-light rounded overflow-hidden">
                    <div class="blog-img position-relative overflow-hidden">
                        <img class="img-fluid" src="<?= base_url() ?>public/front-end-andalalinkita/img/blog-2.jpg"
                            alt="">
                        <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                            href="">Web Design</a>
                    </div>
            ...
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                <div class="blog-item bg-light rounded overflow-hidden">
                    <div class="blog-img position-relative overflow-hidden">
                        <img class="img-fluid" src="<?= base_url() ?>public/front-end-andalalinkita/img/blog-3.jpg"
                            alt="">
                        <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                            href="">Web Design</a>
                    </div>
        ...
        <div class="container py-5 mb-5">
            <div class="bg-white">
                <div class="owl-carousel vendor-carousel">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-1.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-2.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-3.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-4.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-5.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-6.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-7.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-8.jpg" alt="">
                    <img src="<?= base_url() ?>public/front-end-andalalinkita/img/vendor-9.jpg" alt="">
                </div>
            </div>
        </div>
    </div> -->
