            ...
            <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                ...
                <div class="link-animated d-flex flex-column justify-content-start">
                    <?php foreach ($data['categories'] as $category): ?>
                        <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="<?= base_url('news/category/'.$news_item['category_name']) ?>">
            ...
            <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                ...
                <?php foreach ($data['latest_news'] as $latest_news): ?>
                    <div class="d-flex rounded overflow-hidden mb-3">
                        ...
                        <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0"><?= $latest_news['title'] ?>
                        </a>
                    </div>
                <?php endforeach; ?>
                <!-- <div class="d-flex rounded overflow-hidden mb-3">
