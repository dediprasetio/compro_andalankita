    ...
    <div class="col-lg-3 col-md-3 col-sm-12">
        <div class="card">
            <div class="card-header bg-transparent header-elements-inline">
                <span class="card-title font-weight-semibold"><b> Properti Import Excel <i class="icon-folder-upload ml-2"></i></b></span>
            </div>
                ...
                <div class="card card-body">
                    <div class="media mb-3">
                        ...
                        <div class="media-body">
                            ...
                            <span class="text-muted">Total kalkulasi Properti yang terdaftar pada perusahaan</span>
                        </div>
                    </div>
                ...
                <div class="card card-body">
                    <div class="media mb-3">
                        ...
                        <div class="media-body">
                            ...
                            <span class="text-muted">Kalkulasi properti baik yang sudah terjual dan juga disewa</span>
                        </div>
                    </div>
                ...
                <div class="card card-body">
                    <div class="media mb-3">
                        ...
                        <div class="media-body">
                            ...
                            <span class="text-muted">Kalkulasi Semua Properti yang siap dijual dan juga disewakan</span>
                        </div>
                    </div>
