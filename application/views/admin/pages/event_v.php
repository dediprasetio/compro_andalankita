            ...
            <form action="#" class="form-horizontal" name="add" id="add-user">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="content" id="editor-full" class="left-auto">
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Lokasi dilaksanakannya agenda" class="form-control" name="location">
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="#" class="form-horizontal" name="edit" id="edit">
                ...
                <div class="form-group row">
                        <label class="col-form-label col-sm-3">Judul <?= $page_title ?> <br><sub class="text-teal">(Judul akan ditampilkan pada daftar agenda.)</sub></label>
                        <div class="col-sm-9">
                            <input type="hidden" placeholder="" class="form-control" name="event_id" id="event_id">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-3">Lokasi</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="Lokasi dilaksanakannya agenda" class="form-control" name="location" id="location">
                        </div>
                    </div>
