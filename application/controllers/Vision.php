...
class Vision extends Main_controller
{
	...
	{
		$data = array(
			'content' 		=> 'frontend/page/vision_v',
			'breadcrumb' 	=> '<a href="" class="h5 text-white">Home</a>
								<i class="far fa-circle text-white px-2"></i>
								<a href="" class="h5 text-white">Tentang Kami</a>
								<i class="far fa-circle text-white px-2"></i>
								<a href="" class="h5 text-white">Visi Kami</a>',
			'active_menu'	=> 'history',
			'data' => array(
				'page_data' => $this->m_main->view_where('pages', array('page_code' => 'vision'))->row(),
