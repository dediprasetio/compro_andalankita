...
class Vision_mission extends Main_controller
{
	...
	{	
		$data = array(
			'content' 		=> 'frontend/page/vision_mission_v',
			...
			'active_menu'	=> 'vision_mission',
			'data' => array(
				'page_data' => $this->m_main->view_where('pages', array('page_code' => 'vision_mission'))->row(),
				'page_data_vision' => $this->m_main->view_where('pages', array('page_code' => 'vision'))->row(),
				'page_data_mission' => $this->m_main->view_where('pages', array('page_code' => 'mission'))->row(),
